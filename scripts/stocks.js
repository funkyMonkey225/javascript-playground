...
function average(array) {
    var total = array.reduce(getSum, 0);
    return (total / dataz.length);
}

function getSum2(propName) {
    return function (tally, currentElement) {
         return (tally + Number(currentElement[propName]));
    }
}
...
function averageMaker(fn) {
    return function (array){
        return calculateAverage(array.reduce(fn, 0));
    }
}
